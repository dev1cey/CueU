    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.matchNoticeCard}>
          <Ionicons name="calendar-outline" color="#7C3AED" size={48} style={styles.matchIcon} />
        ...
        <View style={styles.card}>
          <View style={styles.cardHeader}>
            ...
            <TouchableOpacity style={styles.viewAllButton}>
              ...
              <Ionicons name="chevron-forward-outline" color="#7C3AED" size={16} />
            </TouchableOpacity>
          </View>
          <View style={styles.rankingsList}>
            {topRankings.map((player) => (
              <TouchableOpacity key={player.rank} style={styles.rankingItem}>
                ...
                <Ionicons name="chevron-forward-outline" color="#9CA3AF" size={16} />
              </TouchableOpacity>
            ))}
          </View>
        </View>
            ...
            {events.map((event) => (
              <TouchableOpacity key={event.id} style={styles.eventItem}>
                <View style={styles.eventIconContainer}>
                  <Ionicons name="trophy-outline" color="#7C3AED" size={20} />
                </View>
                <View style={styles.eventInfo}>
                  <Text style={styles.eventTitle}>{event.title}</Text>
                  <View style={styles.eventDetails}>
                    <Ionicons name="calendar-outline" color="#6B7280" size={12} />
                    <Text style={styles.eventDetailText}>{event.date}, {event.time}</Text>
                  </View>
                  <View style={styles.eventDetails}>
                    <Ionicons name="location-outline" color="#6B7280" size={12} />
